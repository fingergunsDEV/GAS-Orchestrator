/**
 * DOCS_ArchitecturalDesign.gs
 * 
 * This file serves to expose the Architectural Design Markdown document
 * to the Google Apps Script environment natively, allowing agents and 
 * scripts to read the system design directly without requiring GitHub API calls.
 */

function getArchitecturalDesignDoc() {
  return `# Architectural Design: Agentic Layer (v3.1)
